...
- Backend generation is intentionally stateless per turn:
	- clears KV cache before/after inference,
	- enforces context guards,
	- pre-decodes prompt in safe chunks (`n_batch=512`) to avoid long-prompt crashes.
